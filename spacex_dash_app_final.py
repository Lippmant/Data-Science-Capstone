...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        ...
                                        # Add other options here for specific launch sites
                                    ],
                                value='ALL',  # Default value
                                placeholder="place holder here",
                                searchable=True,  # Disable search functionality
                                clearable=False,  # Disable clear option
                                style={'width': '50%', 'margin': 'auto'}  # Adjust style
                                ),
                                html.Br(),
...
def update_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                     title='Payload Success vs. Payload Mass', labels={'class': 'Success (1 or 0)'})
